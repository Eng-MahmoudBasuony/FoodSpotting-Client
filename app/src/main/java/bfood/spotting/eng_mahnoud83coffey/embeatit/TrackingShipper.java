...
public class TrackingShipper extends FragmentActivity implements OnMapReadyCallback {
            ...
            {super.onLocationResult(locationResult);
                    ...
                    geoFireDataBase
                        ...
                        public void onLocationResult(String key, GeoLocation location)
                        {
                            ...
                            mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(location.latitude,location.longitude),15) );
